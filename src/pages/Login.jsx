    ...
    <div className="h-screen w-screen overflow-y-scroll overflow-x-hidden">
      <div>
        <div className="flex flex-col items-center justify-center ">
          ...
          <div className="hero flex flex-col justify-center mt-32">
            <div className="hero-content flex-col justify-around items-start lg:flex-row-reverse py-0">
              ...
              <div className="w-[50%] flex flex-col justify-start mt-20">
                <h1 className="text-5xl font-bold text-left font-[spotify-bold] leading-sung">
      ...
      <div className="flex flex-col items-center justify-center w-full bg-base-200">
        <div className="mb-10">
          <div className="mt-24 max-w-md xl:max-w-7xl">
            <h1 className="font-black font-[spotify-bold] text-4xl">
        ...
        <div className="flex flex-row justify-between items-center w-[50%] bg-[#121212] w-[80%] max-w-md xl:max-w-7xl rounded-lg pl-32 pt-8 mb-5">
          <div className="flex flex-col w-[60%]">
            <h1 className="text-left font-black font-[spotify-bold] text-4xl">
              Analyze your listening activity
            </h1>
            <p className="py-2 text-gray-500 text-left font-[spotify-mid] text-xl">
              Try it now
            </p>
            <button
              class="btn btn-wide btn-sm bg-s_green text-s_black font-[spotify-mid] capitalize hover:bg-s_green rounded-lg btn-md hover:scale-105"
              onClick={loginHandler}
            >
              {(!isLoaded && (
                <span className="loading loading-spinner"></span>
          ...
          {/* <div className="flex flex-row justify-end bg-[#FFF]"> */}
          <img
      ...
      <footer className="footer items-center justify-around gap-y-4 p-10 bg-[#121212] text-base-content rounded">
        <aside className="inline text-s_green">
          Copyright © 2023 By
